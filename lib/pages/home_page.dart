...
class HomePage extends StatelessWidget {
  ...
  Widget _buildContent(BuildContext context, HomeViewModel model) {
  ...
  Widget _buildBody(BuildContext context, HomeViewModel model) {
    return TabBarView(
      children: model.tags.map((e) {
        return HomeChildPage(e);
      }).toList(),
    );
  }

  PreferredSize _tabbar(HomeViewModel model) {
    var tabbar = TabBar(
  ...
  SliverAppBar _sliverAppBar(bool innerBoxIsScrolled, HomeViewModel model) {
...
class HomeChildPage extends StatefulWidget {
  ...
  HomeChildPage(this.tag, {Key? key}) : super(key: key);
...
class _HomeChildPageState extends State<HomeChildPage>
  ...
  Widget build(BuildContext context) {
    super.build(context);
    return ChangeNotifierProvider(
      create: (ctx) => HomeChildViewModel(widget.tag),
      builder: (context, child) {
        return Consumer<HomeChildViewModel>(builder: (context, model, child) {
          if (model.isBusy) {
            return ViewStateBusyWidget();
          }
          if (model.isEmpty) {
  ...
  Widget _buildList(BuildContext context, HomeChildViewModel model) {
